...
class SecondActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        spannableString6Copy.setSpan(subscriptSpan, 5 , spannableString6Copy.length, Spanned.SPAN_INCLUSIVE_EXCLUSIVE)
        ...
        spannableString10.setSpan(clickableSpan10, 5 , spannableString10.length, Spanned.SPAN_INCLUSIVE_EXCLUSIVE)
