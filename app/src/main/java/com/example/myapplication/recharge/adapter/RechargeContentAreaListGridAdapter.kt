...
class RechargeContentAreaListGridAdapter(@LayoutRes layoutResId: Int, data: MutableList<GetFeedListData.FeedListBean.PicListBean>) :
    BaseQuickAdapter<GetFeedListData.FeedListBean.PicListBean, BaseViewHolder>(layoutResId, data) {

     fun convert(holder: BaseViewHolder, item: GetFeedListData.FeedListBean.AdListBean) {
